...
$\varnothing\to x$\verb| / _#|
  ...
  \\\midrule
  \begin{tabular}{l}
    AAx (same/same/constant)\\Gerken~\cite{gerken2010infants}
    \end{tabular}&
  \begin{tabular}{l}
        wowok\\
    lolok\\
...
$\varnothing\to x$\verb| / _#|
  ...
  \begin{tabular}{l}
    ...
    \end{tabular}\\\midrule
  \begin{tabular}{l}
    AxA (same/constant/same)\\Gerken~\cite{gerken2010infants}
    \end{tabular}&
  \begin{tabular}{l}
        wokawo\\
    lokalo\\
  ...
  \end{tabular}&
  \begin{tabular}{l}
$\varnothing$ $\to$ \textipa{a} / \verb|# _| \\
    $\varnothing$ $\to$ \textipa{k} / \verb|# _| \\
    $\varnothing$ $\to\sigma_i$  / \verb|# _| $\sigma$ $\sigma_i$
  \end{tabular}&
  \begin{tabular}{l}
