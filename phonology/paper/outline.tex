...
$r_1$:      $\varnothing\to \sigma_i$\verb| / #_|$\sigma \sigma_i$};
    ...
    \node[orange,draw,align = left] (polishObservation) at (4.5,-11.5) {\verb|horn, singular:| \textipa{ruk}\\\verb|horn, plural:| \textipa{rogi}};
