...
\begin{figure}
  \begin{tikzpicture}
    ...
    \node(AABmorphology) [draw,align = left] at (\syntheticX,-4){ \verb|observation|$\to$\verb|stem|};

    \node(AABphonologyLabel) at (\syntheticX,-5.5) {AAB Phonology};
    \node(AABphonology) [draw,align = left] at (\syntheticX,-6) {%
      $r_1$:      $\varnothing\to \sigma_i$\verb| / #_|$\sigma_i$};
    ...
    \node(Chinesemorphology) [draw,align = left] at (\ChineseX,-4){ \verb|observation|$\to$\verb|stem|+/\textipa{d@}/};
    ...
    \node(p1) [align = left] at (\syntheticX - 1,-8) {\verb|stem:| \textipa{pofe}};
    \node(p2) [draw,align = left] at (\syntheticX - 1,-9.5) {\textipa{pofe}\nextForm{r_1}\\\textipa{popofe}};
    \draw [thick,->] (p1.south) -- (p2.north);
    
    \node(w1) [align = left] at (\syntheticX + 1,-8) {\verb|stem:| \textipa{wug@}};
    ...
    \node(AABlexiconBox)[black,draw,ultra thick, fit = (p1) (w1) (AABvocabulary)] {};
    ...
    \node(ChineselexiconBox)[black,draw,ultra thick, fit = (p1) (w1) (Chinesevocabulary)] {};
    ...
    \node(polishLexicon)[black,draw,ultra thick, fit = (crib) (Cingular) (plural) (polishObservation)] {};
