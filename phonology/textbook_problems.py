...
[
   # simple form        prefixed form        gloss
     (u"lempar",        u"məlempar",None),       #'throw'
     (u"rasa",          u"mərasa",None),         #'feel'
     (u"wakil",None,         u"məwakili"),       #'represent'
     (u"yakin",None,         u"məyakini"),       #'convince'
     (u"masak",         u"məmasak",None),        #'cook'
     (u"nikah",         u"mənikah",None),        #'marry'
     (u"ŋaco",          u"məŋaco",None),         #'chat'
     (u"ɲaɲi",          u"məɲaɲi",None),         #'sing'
     (u"hituŋ",         u"məŋhituŋ",None),       #'count'
     (u"gambar",        u"məŋgambar",None),      #'draw a picture'
     (u"kirim",         u"məŋirim",None),        #'send'
     (u"dəŋar",         u"məndəŋar",None),       #'hear'
     (u"tulis",         u"mənulis",None),        #'write'
     (u"bantu",         u"məmbantu",None),       #'help'
     (u"pukul",         u"məmukul",None),        #'hit'
     (u"ǰahit",         u"mən̆ǰahit",None),       #'sew'
     (u"čatat",         u"mən̆čatat",None),       #'note down'
     (u"ambil",         u"məŋambil",None),       #'take'
     (u"isi",           u"məŋisi",None),         #'fill up'
     (u"undaŋ",         u"məŋundaŋ",None),       #'invite'
],
solutions=[u'''
stem
mə + stem + i
